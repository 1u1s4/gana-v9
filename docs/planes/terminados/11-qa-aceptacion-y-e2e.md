...
- `API_FOOTBALL_KEY`
- `DATABASE_URL`
- auth local de Codex/deprecated provider segun `AGENT_PROVIDER`; para `openrouter`, `OPENROUTER_API_KEY`.
...
3. `/provider` cambia entre Codex, deprecated provider y OpenRouter cuando estan configurados.
