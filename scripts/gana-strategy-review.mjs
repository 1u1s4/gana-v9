...
const env = {
  ...
  AGENT_MODEL: process.env.GANA_STRATEGY_REVIEW_MODEL ?? process.env.AGENT_MODEL ?? 'gpt-6-astra',
  AGENT_REASONING_EFFORT: process.env.GANA_STRATEGY_REVIEW_REASONING_EFFORT ?? process.env.AGENT_REASONING_EFFORT ?? 'medium',
