...
export GANA_DAILY_CODEX_MODEL="${GANA_DAILY_CODEX_MODEL:-gpt-6-astra}"
export GANA_DAILY_REASONING_EFFORT="${GANA_DAILY_REASONING_EFFORT:-medium}"
export GANA_DAILY_FAST_MODE="${GANA_DAILY_FAST_MODE:-false}"
export GANA_DAILY_CODEX_FALLBACK_MODELS="${GANA_DAILY_CODEX_FALLBACK_MODELS-}"
export GANA_DAILY_REQUIRED_LEAGUES="${GANA_DAILY_REQUIRED_LEAGUES:-auto}"
