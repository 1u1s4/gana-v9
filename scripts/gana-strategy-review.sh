...
export GANA_STRATEGY_REVIEW_MODEL="${GANA_STRATEGY_REVIEW_MODEL:-gpt-5.5}"
export GANA_STRATEGY_REVIEW_REASONING_EFFORT="${GANA_STRATEGY_REVIEW_REASONING_EFFORT:-xhigh}"
