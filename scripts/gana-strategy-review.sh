...
export GANA_STRATEGY_REVIEW_MODEL="${GANA_STRATEGY_REVIEW_MODEL:-gpt-6-astra}"
export GANA_STRATEGY_REVIEW_REASONING_EFFORT="${GANA_STRATEGY_REVIEW_REASONING_EFFORT:-medium}"
