...
import {
  ...
  YELLOW,
  printArtifacts,
  printCertificationResult,
  printDailyE2EResult,
  printDailyMetricsResult,
  printExportResult,
  printFiltersStatus,
  printFixtures,
  printKeyValue,
  printLeaderboardRows,
  printLongRunningLowOddsNotice,
  printLowOddsScan,
  printOdds,
  printParlayAnalysisResult,
  printParlayResult,
  printResearchResult,
  printRunResult,
  printScoringResult,
  printServiceStatus,
  printStrategyReviewResult,
  printValidationResult,
  type ArtifactListResult,
} from './commands/printers.js';
...
export function printHeadlessUsage(): void {
  ...
  console.log(`  ${CYAN}pnpm gana parlay --run-id RUN_ID --portfolio low-variance|balanced|totals|high-conviction|market-diverse|parlay-oro|parlay-diamante|parlay-all-in|parlay-refinado${RESET}`);
