export const DASHBOARD_THEME_BOOTSTRAP_BLOCK = String.raw`  <script>
    (function () {
      try {
...
export const DASHBOARD_STYLE_BLOCK = String.raw`  <style>
    :root {
      color-scheme: dark;
...
export const DASHBOARD_CLIENT_SCRIPT_BLOCK = String.raw`  <script>
    (function () {
      const TAB_LABELS = {
        fixtures: 'Partidos',
