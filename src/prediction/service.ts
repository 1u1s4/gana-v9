...
import {
  ...
  evidencePromptView,
  fixturePromptView,
  hasRealWebResearchSource,
  isRealWebSourceRecord,
  oddsSnapshotPromptView,
  researchBundlePromptView,
  selectScoringPromptQuotes,
  sourcePromptView,
  toAllowedQuote,
...
const REVIEW_ONLY_MODELS = new Set(['gpt-5.6-luna']);
